      ...
      <div class="card px-1 py-4">
        <div class="card-body">
          ...
          <div v-if="questionType === 'codigo'">
            ...
            <div class="row">
              <div class="input-group">
                <textarea class="form-control" aria-label="With textarea" placeholder="Descripción" v-model="description"></textarea>
              </div>
            </div>
            <div class="row">
              <div class="col-sm-12">
                <div class="form-group">
                  <label for="difficulty">¿Cuál es la dificultad?</label>
              ...
              <div class="col-sm-12">
                <div class="form-group">
                  <label for="theme">¿Cuál es el tema?</label>
                  <select id="theme" class="form-select" v-model="selectedTheme">
                    <option selected>Choose...</option>
            ...
            <div class="d-flex flex-row">
              <div class="row">
                <div class="input-group mb-3" v-for="(input, index) in inputs" :key="index">
                  <input type="text" class="form-control" placeholder="Input" v-model="inputs[index].input" />
                  <input type="text" class="form-control" placeholder="Output" v-model="inputs[index].output" />
                </div>
                <div>
          ...
          <div v-if="questionType === 'multiple'">
            ...
            <div class="form-check form-switch">
              <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" v-model="hints" />
...
export default {
    ...
    methods: {
        ...
        submitForm() {
            // Aquí puedes procesar los datos del formulario, como enviarlos a un servidor o realizar otras acciones necesarias.
            // Una vez que los datos del formulario se hayan procesado, puedes emitir un evento personalizado para notificar al componente ListView.
            const formData = {
                title: this.title,
                dificultad: this.selectedDifficulty,
                tema: this.selectedTheme,
                autor: this.author
            };

            this.$root.$emit('formSubmitted', formData);
        },
        generateJSON() {
